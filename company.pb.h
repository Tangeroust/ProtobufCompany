...
class Company final :
 ...
 public:
  ...
  enum : int {
    ...
    kYearFieldNumber = 1,
    kForeignEconomicActivFieldNumber = 5,
  };
  ...
  // optional bool foreignEconomicActiv = 5;
  bool has_foreigneconomicactiv() const;
  private:
  bool _internal_has_foreigneconomicactiv() const;
  public:
  void clear_foreigneconomicactiv();
  bool foreigneconomicactiv() const;
  void set_foreigneconomicactiv(bool value);
  private:
  bool _internal_foreigneconomicactiv() const;
  void _internal_set_foreigneconomicactiv(bool value);
  public:
...
// optional bool foreignEconomicActiv = 5;
inline bool Company::_internal_has_foreigneconomicactiv() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Company::has_foreigneconomicactiv() const {
  return _internal_has_foreigneconomicactiv();
}
inline void Company::clear_foreigneconomicactiv() {
  foreigneconomicactiv_ = false;
  _has_bits_[0] &= ~0x00000010u;
}
inline bool Company::_internal_foreigneconomicactiv() const {
  return foreigneconomicactiv_;
}
inline bool Company::foreigneconomicactiv() const {
  // @@protoc_insertion_point(field_get:Company.foreignEconomicActiv)
  return _internal_foreigneconomicactiv();
}
inline void Company::_internal_set_foreigneconomicactiv(bool value) {
  _has_bits_[0] |= 0x00000010u;
  foreigneconomicactiv_ = value;
}
inline void Company::set_foreigneconomicactiv(bool value) {
  _internal_set_foreigneconomicactiv(value);
  // @@protoc_insertion_point(field_set:Company.foreignEconomicActiv)
}

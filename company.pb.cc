...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, foreigneconomicactiv_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ation\030\004 \001(\t\022\034\n\024foreignEconomicActiv\030\005 \001("
  "\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 121, descriptor_table_protodef_company_2eproto, "company.proto", 
...
class Company::_Internal {
 public:
  ...
  static void set_has_foreigneconomicactiv(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Company::Company(const Company& from)
  ...
  ::memcpy(&year_, &from.year_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreigneconomicactiv_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreigneconomicactiv_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&foreigneconomicactiv_) -
    reinterpret_cast<char*>(&year_)) + sizeof(foreigneconomicactiv_));
}
...
// @@protoc_insertion_point(message_clear_start:Company)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&foreigneconomicactiv_) -
        reinterpret_cast<char*>(&year_)) + sizeof(foreigneconomicactiv_));
  }
  _has_bits_.Clear();
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_foreigneconomicactiv(&has_bits);
          foreigneconomicactiv_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_foreigneconomicactiv(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Company)
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      foreigneconomicactiv_ = from.foreigneconomicactiv_;
    }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, foreigneconomicactiv_)
      + sizeof(Company::foreigneconomicactiv_)
      - PROTOBUF_FIELD_OFFSET(Company, year_)>(
